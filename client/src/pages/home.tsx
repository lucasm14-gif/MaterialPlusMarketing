                ...
                {teamMembers.map((url, index) => (
                  <div 
                    ...
                    className={`w-28 h-28 md:w-44 md:h-44 rounded-full ${
                      index !== teamMembers.length - 1 ? '-mr-4 md:-mr-6' : ''
                    } relative z-${index + 1}0 border-[3px] border-white overflow-hidden shadow-lg`}
                    style={{ backgroundImage: 'linear-gradient(45deg, #ff0000, #ff0000)' }}
                  >
                    <img 
